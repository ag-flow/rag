...
describe("WorkspaceDetailTab", () => {
  it("affiche les statistiques du workspace", () => {
    renderWithProviders(
      <WorkspaceDetailTab workspace={mockWorkspace} enabled={true} onReveal={() => {}} onRotate={() => {}} />,
    );
  ...
  it("déclenche onReveal au click sur Révéler", () => {
    ...
    renderWithProviders(
      <WorkspaceDetailTab workspace={mockWorkspace} enabled={true} onReveal={onReveal} onRotate={() => {}} />,
    );
