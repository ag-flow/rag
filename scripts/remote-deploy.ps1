# remote-deploy.ps1 - Lance <APP_DIR>/dev-deploy.sh sur une machine de test
# (APP_DIR + COMPOSE_FILE lus depuis le .env ; defauts /opt/rag + docker-compose-dev.yml)
#
...
$remoteCmd = "cd $appDir && ./dev-deploy.sh $branch && " +
