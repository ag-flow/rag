...
def test_delete_model_204(admin_client: TestClient, admin_headers: dict[str, str]) -> None:
    ...
    r = admin_client.delete("/admin/models/custom/m-e2e-del", headers=admin_headers)
...
def test_delete_model_409_in_use(
    ...
    r = admin_client.delete("/admin/models/openai/text-embedding-3-small", headers=admin_headers)
    assert r.status_code == 409
